...
export const researchJourney: {
...
}[] = [
  {
    year: "2024",
    status: "completed",
    items: ["Started BS Software Engineering at NUST"],
  },
  {
    year: "2025",
    status: "completed",
    items: [
      "Strengthened foundations in Algorithms, Operating Systems, Computer Networks, Probability & Statistics, and Software Engineering",
    ],
  },
  {
    year: "2026",
    status: "current",
    items: [
      "Moving toward Machine Learning, Deep Learning, AI systems, and research-oriented projects",
    ],
  },
  {
    year: "2026+",
    status: "current",
    items: ["Building PCBDefect-X, FraudShield, and a research portfolio"],
  },
  {
    year: "2027+",
    status: "future",
    items: [
      "Target: research internship, MITACS, international research collaboration, FYP research",
    ],
  },
];
