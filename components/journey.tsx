...
export function Journey() {
  return (
    <section id="journey" className="relative mx-auto max-w-content px-6 py-28 md:py-36">
      <SectionHeading id="journey"
        eyebrow="04 — RESEARCH JOURNEY" title="Research journey" icon={Milestone} />
